...
const ProtfolioCardReverse = ({ logo, spanTitle, title, desc, image }) => {

    const blueGradient = {
        background: 'linear-gradient(298deg, #951314 0%, #EB2022 100%)'
    }
    return (
        <div className='flex flex-col-reverse mdd:flex-row-reverse my-[20px] overflow-hidden rounded-[30px] min-h-[40vh] h-full mdd:h-[70vh] w-full relative place-content-center items-center justify-start'>
